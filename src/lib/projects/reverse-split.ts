...
export const reverseSplit: Project = {
	...
	eyebrow: 'Automation',
	tagline:
		'A pipeline that ingests SEC reverse-split filings as they are posted, classifies their fractional-share terms with an LLM, and routes confirmed opportunities through a multi-broker execution layer.',
	overview: [
